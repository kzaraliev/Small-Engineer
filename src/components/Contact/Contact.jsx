...
function Contact() {
    return (
        <div className={styles.contact}>
            ...
            <p className={styles.subtitle}>Свържете се с нас чрез съобщение или ни намерете в социалните мрежи. Ще се радваме да чуем вашето мнение и сме готови да отговорим на всички ваши въпроси!</p>
            <ul className={styles.contacts}>
                <li className={styles.contactElement}>
                    <a href="#" /*target="_blank" rel="noreferrer"*/><MdEmail className={styles.icon} /></a>
                    <h3 className={styles.contactTitle}>E-mail</h3>
                </li>
                <li className={styles.contactElement}>
                    <a href="#" /*target="_blank" rel="noreferrer"*/><FaInstagram className={styles.icon} /></a>
                    <h3 className={styles.contactTitle}>Instagram</h3>
                </li>
                <li className={styles.contactElement}>
                    <a href="#" /*target="_blank" rel="noreferrer"*/><FaTiktok className={styles.icon} /></a>
                    <h3 className={styles.contactTitle}>Tiktok</h3>
                </li>
            </ul>

            <Accordion className={styles.accordion}>
                <h2 className={styles.accordionTitle}>Често задавани въпроси</h2>
